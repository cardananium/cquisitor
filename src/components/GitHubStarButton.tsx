...
const GITHUB_REPO = "cardananium/cquisitor";
const GITHUB_URL = `https://github.com/${GITHUB_REPO}`;
const GITHUB_STAR_URL = `https://github.com/${GITHUB_REPO}/stargazers`;
  ...
  return (
    <div className="github-button-wrapper">
      <a
        ...
        aria-label="View cardananium/cquisitor on GitHub"
      >
        <svg
          viewBox="0 0 16 16"
          width="16"
      ...
      <a
        ...
        aria-label="Star cardananium/cquisitor on GitHub"
      >
