// Canonical Plutus operator order for cost-model arrays. Used to translate
// Blockfrost's named-key cost_models response into the index-based array form
// the validator (and Koios) expects. PlutusV1/V2 happen to be alphabetical;
// PlutusV3 is not. Source: acropolis/modules/rest_blockfrost/src/cost_models.rs
// (extracted 2026-05-04).
//
// Patch: acropolis's V3 list has `quotientInteger-memory-arguments-minimum`
// (a key that doesn't exist in any deployed cost model) and is missing
// `remainderInteger-memory-arguments-minimum`. Verified against Koios's V3
// array — the corrected order below produces an exact match. Without the
// patch, script_data_hash mismatches cascade across 11 entries (139–149).

export const PLUTUS_V1_ORDER: readonly string[] = [
...
export const PLUTUS_V2_ORDER: readonly string[] = [
  "addInteger-cpu-arguments-intercept",
  "addInteger-cpu-arguments-slope",
  "addInteger-memory-arguments-intercept",
  "addInteger-memory-arguments-slope",
...
export const PLUTUS_V3_ORDER: readonly string[] = [
  "addInteger-cpu-arguments-intercept",
  "addInteger-cpu-arguments-slope",
  "addInteger-memory-arguments-intercept",
  "addInteger-memory-arguments-slope",
