...
//
// Sourced from sundae-tx-tools/mainnet.blueprint.json (V3 mainnet),
// sundae-tx-tools/plutus-stable-mainnet.json (Stableswap mainnet),
// sundae-portfolio/protocols.json (preview), and well-known sundae-stats
// resources (V1 mainnet escrow address).
//
...
// V1 mainnet script hashes derived from well-known sundae-stats addresses:
