// The Conway-era CDDL schema from IntersectMBO/cardano-ledger, vendored so the
// preset works with no network and cannot change under the reader.
//
//   eras/conway/impl/cddl/data/conway.cddl
//   at commit dae069780697449fbd9cda47f03fb72745b0b8c0
//
// Copyright 2018-2023 Input Output Global Inc (IOG), licensed under the Apache
// License 2.0 <http://www.apache.org/licenses/LICENSE-2.0>. The text below is a
// verbatim copy, its own generated-file header included, so that a diff against
// upstream stays meaningful. String.raw keeps the "\x00" escapes in the script
// comments as the bytes upstream wrote.
//
// Imported dynamically (see loadCardanoPreset) so its 24 KB only reaches a
// reader who asks for the preset.

export const CONWAY_CDDL = String.raw`; This file was auto-generated using generate-cddl. Please do not modify it directly!
